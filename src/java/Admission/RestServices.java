...
/* -------------------- RestService sur les venues  */  
    ...
    @Produces("application/json")
    public List<Venue> findVenue(@DefaultValue("") @QueryParam("ipp") String IPP,@DefaultValue("") @QueryParam("iep") String IEP,@DefaultValue("") @QueryParam("datevenue") String dateVenue){
